<template>
	<div id="accountList">
		<div class="scroller">
			<p class="w_balance">总余额: {{ totalBalance?(totalBalance.length>9?totalBalance.toFixed(6)+'...':totalBalance.toFixed(6)):'0.000000' }} SSP</p>
				...
				<li v-for = "(acount, index ) in accountList">
					<div class="list_l">
						...
						<div>
							...
							<p class="w_account_num">{{Number(accountBalance[acount.account_address])?(accountBalance[acount.account_address].length>200?Number(accountBalance[acount.account_address]).toFixed(6)+'...':Number(accountBalance[acount.account_address]).toFixed(6)):'0.000000'}} SSP</p>
							<div>
								<span>SSP{{acount.account_address}}</span>
								<i @click='exportDialog(acount.account_address)'></i>
                <i class="copy_i" @click="onCopy('SSP' + acount.account_address)"></i>
              </div>
						</div>
					</div>
					<div class="list_r">
